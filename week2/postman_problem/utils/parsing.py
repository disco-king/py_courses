...
"""
default_lines = {
    0: ['Почтовое отделение', (0.0, 2.0)],
    1: ['Ул. Грибоедова, 104/25', (2.0, 5.0)],
    2: ['Ул. Бейкер стрит, 221б', (5.0, 2.0)],
    3: ['Ул. Большая Садовая, 302-бис', (6.0, 6.0)],
    4: ['Вечнозелёная Аллея, 742', (8.0, 3.0)]
    }
